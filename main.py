...
if __name__ == "__main__":
    ...
    product = "LambdaPen - Smart Pencil Extension."

    landing_page_data = generate_landing_page_data(product, linkedin_url)
    print(landing_page_data.model_dump_json(indent=2))
